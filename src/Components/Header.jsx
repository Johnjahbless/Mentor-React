        ...
        <nav className="navbar navbar-expand-md">
            ...
            <div className="navbar-header d-flex align-items-center">
                ...
                <a className="navbar-brand" href="/">
                    <img src="%PUBLIC_URL%/assets/img/logo.jpeg" className="img-fluid logo-desktop" alt="logo" />
                    <img src="%PUBLIC_URL%/assets/img/logo-jpeg" className="img-fluid logo-mobile" alt="logo" />
                </a>
            </div>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <div className="navigation d-flex">
                    <ul className="navbar-nav nav-left">
                        ...
                        <li className="nav-item">
                            <a className="nav-link  " href="javascript:void(0)" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Menu
                    ...
                    <ul className="navbar-nav nav-right ml-auto">
                        ...
                        <li className="nav-item dropdown user-profile">
                            ...
                            <div className="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                ...
                                <div className="p-4">
                                    <Link className="dropdown-item d-flex nav-link" to="/profile/12345">
